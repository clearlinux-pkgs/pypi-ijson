...
Version  : 3.2.0.post0
Release  : 15
URL      : https://files.pythonhosted.org/packages/fe/98/b9c6ef09ec7704f7a5bd55ac56fcd06dd598998a1019c2442df7dd1f9a97/ijson-3.2.0.post0.tar.gz
Source0  : https://files.pythonhosted.org/packages/fe/98/b9c6ef09ec7704f7a5bd55ac56fcd06dd598998a1019c2442df7dd1f9a97/ijson-3.2.0.post0.tar.gz
...
%prep
%setup -q -n ijson-3.2.0.post0
cd %{_builddir}/ijson-3.2.0.post0
pushd ..
cp -a ijson-3.2.0.post0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672849885
