...
Source0  : https://files.pythonhosted.org/packages/a3/4f/1cfeada63f5fce87536651268ddf5cca79b8b4bbb457aee4e45777964a0a/ijson-3.4.0.tar.gz
...
%prep
%setup -q -n ijson-3.4.0
cd %{_builddir}/ijson-3.4.0
pushd ..
cp -a ijson-3.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746713953
